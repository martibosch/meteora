...
- the `stations_gdf` property provides the station metadata as a geopandas geo-data frame [@jordahl2020geopandas] with point geometries that encode station locations in an explicit coordinate reference system
...
Meteora builds on the scientific Python ecosystem, in particular pandas [@mckinney2010data], NumPy [@harris2020array], geopandas [@jordahl2020geopandas], xarray [@hoyer2017xarray], xclim [@bourgault2023xclim], Pint [@grecco2024pint] and Pooch [@uieda2020pooch].
